...
if ( ! class_exists( 'Monstroid2_Lite_Widget_Area' ) ) {

	/**
	 * Class Monstroid2_Lite_Widget_Area.
	 */
	class Monstroid2_Lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'monstroid2_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'monstroid2_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'monstroid2_lite_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function monstroid2_lite_widget_area() {
		return Monstroid2_Lite_Widget_Area::get_instance();
	}

	monstroid2_lite_widget_area();
}
