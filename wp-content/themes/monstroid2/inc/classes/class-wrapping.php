 ...
 */
add_filter( 'template_include', array( 'Monstroid2_Lite_Wrapping', 'wrap' ), 99 );
add_filter( 'monstroid2_lite_wrap_base', 'monstroid2_lite_wrap_base_cpts' );
 ...
 */
function monstroid2_lite_template_path() {
	return Monstroid2_Lite_Wrapping::$main_template;
}
 ...
 */
function monstroid2_lite_template_base() {
	return Monstroid2_Lite_Wrapping::$base;
}

if ( ! class_exists( 'Monstroid2_Lite_Wrapping' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Monstroid2_Lite_Wrapping {
		...
		/**
		 * Initialize new instance of Monstroid2_Lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'monstroid2_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Monstroid2_Lite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Monstroid2_Lite_Wrapping();
		}
	}
}
 ...
 */
function monstroid2_lite_wrap_base_cpts( $templates ) {
