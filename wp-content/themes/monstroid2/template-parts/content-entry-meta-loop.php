...
<?php if ( 'post' === get_post_type() ) : ?>
	...
	<div class="entry-meta">
		...
		<?php $date_visible = monstroid2_lite_is_meta_visible( 'blog_post_publish_date', 'loop' );
		...
		<?php $author_visible = monstroid2_lite_is_meta_visible( 'blog_post_author', 'loop' );
		...
		<?php $comment_visible = monstroid2_lite_is_meta_visible( 'blog_post_comments', 'loop' );
		...
		<?php $cats_visible = monstroid2_lite_is_meta_visible( 'blog_post_categories', 'loop' );
		...
		<?php $tags_visible = monstroid2_lite_is_meta_visible( 'blog_post_tags', 'loop' );
